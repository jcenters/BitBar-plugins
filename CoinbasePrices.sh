...
link_price=$(curl -s -H "CB-Version: 2015-04-08" "https://api.coinbase.com/v2/prices/LINK-USD/buy" | python -c "import sys, json; print(json.load(sys.stdin)['data']['amount'])")
